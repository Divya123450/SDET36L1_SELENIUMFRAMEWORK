...
/**
	 * This class contains all the JS reusable Method/action 
	...
	public final class JSExecutorUtility {
		...
		/**
		 * This method is is used to send the data to textfield using JSExecutor
		 * @param element
		 * @param data
		 */
		...
		/**
		 * This method is used to click on the element using JSEexecutor
		 * @param
		 */
		...
		public void ScrolltillEnd(String strategy) {
			...
			js.executeScript("window.scrollBy(0,"+sign+"document.body.scrollHieght)");
		}
